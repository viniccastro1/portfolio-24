const ReadyToStart: React.FunctionComponent = () => {
  return (
    <div className="flex min-h-screen w-full text-white">
      <div className="bg-blue-400 w-2/5 hidden lg:flex"></div>
      <div className="flex flex-col bg-primarylight w-full lg:w-3/5 lg:pl-10 sm:p-2">
        <p className="fs-h2 mb-6">Ready to start your <span className="text-tertiary">new project</span>?</p>
        <p className="mb-1">Then lets get in touch and we can schedule a call:</p>
